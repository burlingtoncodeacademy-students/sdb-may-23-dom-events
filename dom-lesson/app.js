...
/* 
    ! Challenge
    * Create and instance of a listItem that renders "Clean bedroom"
...
let listUsingQSA = document.querySelectorAll("#ulToDo")
console.log("HERE", list, listUsingQSA)
// ? Access using immediate parent definition
// list.appendChild(li)
// ? Access using immediate NodeList definition
// listUsingQSA[0].appendChild(li)
// ? Access using nested object
// document.body.children[0].children[1].appendChild(li)
